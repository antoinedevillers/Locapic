...
export default function MapScreen() {
  ...
  useEffect(() => {
    fetch(`http://192.168.1.12:3000/places/${user.nickname}`)
  ...
  const handleNewPlace = () => {
    ...
    fetch('http://192.168.1.12:3000/places', {
      method: 'POST',
    ...
    .then(user => {
      ...
      dispatch(addPlace({ name: user.data.name, latitude: user.data.latitude, longitude: user.data.longitude }));
